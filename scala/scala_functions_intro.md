...
not: burda asil yaptigimiz trait'i new keywordu ile kullanarak o trait'ten bir anonymous subclass instantiate ediyoruz aslinda. asagidaki kod java ama scala'da da ayni mantikla calisiyor.
...
```
burdaki EnglishGreeting normal bir subclass veya inner class iken, frenchGreeting ve spanishGreeting birer anonymous inner class. 
